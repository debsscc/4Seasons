...
namespace Yarn.Unity
{
    ...
    public sealed class OptionsPresenter : DialoguePresenterBase
    {
        ...
        [SerializeField] CanvasGroup? canvasAlpha;
        ...
        public override async YarnTask<DialogueOption?> RunOptionsAsync(DialogueOption[] dialogueOptions, CancellationToken cancellationToken)
        {
            ...
            if (useFadeEffect && canvasAlpha != null)
            {
                // fade up the UI now
                await Effects.FadeAlphaAsync(canvasAlpha, 0, 1, fadeUpDuration, cancellationToken);
            }
            ...
            {
                // fade down
                await Effects.FadeAlphaAsync(canvasAlpha, 1, 0, fadeDownDuration, cancellationToken);
            }
