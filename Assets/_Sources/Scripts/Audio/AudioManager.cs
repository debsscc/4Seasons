...
public class AudioManager : Singleton<AudioManager>
{
    ...
    [FoldoutGroup("Debug")]
    [Button("Pausar/Despausar M�sica")]
    ...
    public void PlayMusic(string name)
    {
        ...
        {
            Debug.LogWarning($"[AudioManager] M�sica '{name}' n�o encontrada.");
            return;
        }
    ...
    public void PlaySFX(string name)
    {
        ...
        if (entry == null || entry.Clip == null)
        {
            Debug.LogWarning($"[AudioManager] SFX '{name}' n�o encontrado.");
            return;
        }
    ...
    public void PlayUI(string name)
    {
        ...
        if (entry == null || entry.Clip == null)
        {
            Debug.LogWarning($"[AudioManager] UI '{name}' n�o encontrado.");
            return;
        }
